...
function drawHabitat(t){
  ...
  // bark shelter
  ctx.save();ctx.translate(190,215-(effect&&elapsed<effect.until&&effect.id==='lift'?12:0));ctx.rotate(-.09);ctx.fillStyle="#5a412b";ctx.fillRect(-68,-36,136,72);ctx.fillStyle="#76583a";ctx.fillRect(-64,-32,128,8);for(let i=-55;i<60;i+=18)px(ctx,i,-20,8,46,i%36?"#4b3527":"#6b4d33");ctx.restore();
