...
export function observationTitle(state,scene,encounter,lang='zh'){
 if(isSeaweed(state))return seaweedText(scene.title,lang);
 ...
 if(state.habitatId==='petri-dish'||state.habitatId==='sandy-surf'||state.habitatId==='groundwater'||state.habitatId==='freshwater')return gameText(scene.title,lang);
