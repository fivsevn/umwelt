...
const PEREON={
 ...
 porcellioSpatulatus:{template:'porcellio-spatulatus-pereon',overlap:.08,plateArc:.28,epimera:{lobe:'shield',skirt:1,flare:.26,angle:.08,roundness:.18,tip:'broad',widthScale:1.08,posteriorProjection:.08},confidence:'species-proxy'},
