...
const ASSETS=[
 ...
 {id:'ulva-clump-01',category:'aquatic',scenes:['shallow-marine','estuary'],label:'Sea lettuce',note:'浅海 / 石莼叶簇',radius:34,params:{kind:'ulva',height:38,flow:42}},
 ...
 {id:'crustose-algae-01',category:'aquatic',scenes:['intertidal','shallow-marine','estuary'],label:'Crustose algae',note:'壳状藻 / 灰紫附着斑',radius:34,params:{labDetail:'crustose'}},
 ...
 {id:'bark-log-01',category:'bark',scenes:['forest','freshwater','estuary'],label:'Mossy broken log',note:'断木 / 附苔',radius:68,params:{variant:2,scale:1.02}},
 {id:'bark-shelter-01',category:'bark',scenes:['forest'],label:'Bark shelter 01',note:'树皮 / 躲避',radius:112,params:{variant:0,scale:1.16}},
 {id:'bark-fragment-01',category:'bark',scenes:['forest','freshwater','estuary'],label:'Bark fragment 01',note:'树皮 / 碎片',radius:68,params:{variant:1,scale:.96}},

 {id:'stone-round-01',category:'stone',scenes:['forest','freshwater','intertidal','shallow-marine','estuary'],label:'Stone round 01',note:'石块 / 圆',radius:18,params:{variant:0,scale:1}},
 ...
 {id:'stone-shard-01',category:'stone',scenes:['forest','freshwater','intertidal','shallow-marine','estuary'],label:'Stone shard',note:'石块 / 缺角碎石',radius:18,params:{variant:2,scale:1}},
 ...
 {id:'twig-01',category:'debris',scenes:['forest','freshwater','estuary'],label:'Twig 01',note:'细枝',radius:24,params:{length:24}},
 {id:'woodchip-01',category:'debris',scenes:['forest','freshwater','estuary'],label:'Wood chip 01',note:'木屑 / 碎片',radius:26,params:{variant:0,scale:.82}},
 {id:'woodchip-02',category:'debris',scenes:['forest','freshwater','estuary'],label:'Wood chip 02',note:'木屑 / 长片',radius:30,params:{variant:1,scale:.72}}
];
