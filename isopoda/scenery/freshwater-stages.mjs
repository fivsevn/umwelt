...
// Older stages use compact rows; updated exports retain every authored field.
// Stage identity is normalized to the fixed material-cycle order.
...
const STAGES=[STAGE_01,STAGE_02,STAGE_03,STAGE_04,STAGE_05];
...
export const FRESHWATER_STAGE_LAYOUTS=Object.freeze(STAGES.map((data,index)=>Object.freeze({
 ...(Array.isArray(data)?{
  version:1,
  canvas:{width:384,height:430},
  angleUnit:'radians',
  background:structuredClone(BACKGROUND),
  objects:data.map(expand),
