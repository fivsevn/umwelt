...
export function renderCredits(){
 ...
 content??=fetch(new URL('./credits.md?v=credits-2',import.meta.url)).then(response=>{if(!response.ok)throw new Error('Credits unavailable');return response.text()}).catch(error=>{content=null;throw error});
