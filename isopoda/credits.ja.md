...
- [Fusion Pixel Font / 缝合像素字体](https://github.com/TakWolf/fusion-pixel-font) — TakWolf — SIL Open Font License 1.1
...
**[アシモフ形態実験室へ](https://umwelt.fivsevn.com/isopoda/morphology/)**

**[アシモフ環境実験室へ](https://umwelt.fivsevn.com/isopoda/habitat)**


標本箱の縮尺は現実の成体のおおよその大きさを示し、画面上の実寸ではありません。成体の計測平均や範囲の中間値を目安とし、最大記録は使用しません。すべての地域・性別・系統に共通する統計平均ではありません。体長は原則として触角と尾肢を含まず、資料と測定基準は形態実験室に掲載しています。適切な成体資料がない場合は体長未確認と表示します。見やすさのためゲームの体格と個体差を調整しており、標本箱ごとの倍率も異なります。
