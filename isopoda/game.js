...
import {ENDINGS} from './content.mjs?v=narrative-pool-1';
import {createRun,validRun,migrateV3,runSpecies,migrateLegacy,ensureScene,choose,advance,timeFor,recordDirectInteraction,endingMemoryFor} from './engine.mjs?v=narrative-pool-1';
