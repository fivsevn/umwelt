...
import {createHabitat} from './habitat.mjs?v=bubbles-1';
...
function render(){
 ...
 $('#dayLabel').textContent=clock();$('#recordTitle').textContent=state.stage==='feedback'?'后来':'此刻';$('#observation').textContent=state.stage==='feedback'?state.feedback:scene.text;
