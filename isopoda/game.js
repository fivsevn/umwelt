...
function render(){
 ...
 const cue=state.habitatId==='sandy-surf'?gameText('sand:hint',getLanguage()):state.stage==='feedback'?(state.interactionIntent?.hint||''):'';$('#interactionCue').hidden=!cue;$('#interactionCue').textContent=cue;
