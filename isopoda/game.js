import {habitatConfig,cycleHabitat} from './habitats.mjs?v=abyssal-5';
import {AQUATIC_ENDINGS,aquaticFeedback} from './aquatic-story.mjs?v=abyssal-9';
...
import {createRun,validRun,migrateV3,migrateV4,runSpecies,migrateLegacy,ensureScene,choose,advance,timeFor,recordDirectInteraction,endingMemoryFor} from './engine.mjs?v=abyssal-11';
import {makeBug,makeIsopod,renderModel,exuviaPixels} from './sprites.mjs?v=swim-2';
import {createHabitat} from './habitat.mjs?v=abyssal-4';
