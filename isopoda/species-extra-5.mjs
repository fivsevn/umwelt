...
// Special marine reference specimen requested via the hobby nickname “海参鼠妇”. This is a real
// marine asellote, NOT a terrestrial Oniscidea woodlouse and therefore must never enter the
// terrestrial habitat draw. The display name below is a project translation, not a formal Chinese name.
...
export const SEA_CUCUMBER_ISOPOD={
 ...
 status:'正式海洋等足类；“海参共栖等足虫”为项目中文名，“海参鼠妇”保留为粉丝 / 爱好者称呼。属于 Asellota，不是陆生 Oniscidea，因此仅作为海洋参考标本，不进入陆生饲养盒抽取。',
 ...
 names:{zhCN:'海参共栖等足虫',zhAliases:['海参鼠妇','海参伴生等足虫'],zhNameType:'project_translation',zhConfidence:'medium',en:'Sea-cucumber Commensal Isopod',enNameType:'project_translation',ja:null,jaAliases:[]},
