...
export const ENCOUNTERS=[
 ...
 {id:'molt-back',motion:'molt',molt:'posterior',actors:1,place:[148,236],title:'尚未离开的旧物',lines:['木片旁的一个后半身颜色较浅，几节甲片像还没有完全离开原来的表面。','同一只身体，前后像隔着一小段时间。'],quiet:'它仍停在原处。你没有把等待记成一次故障。',care:'新遮蔽物留下更深的阴影，浅色后半身慢慢退了进去。',disturb:'它缩近木片，浅色的后半身也跟着退入阴影。'},
