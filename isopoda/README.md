...
The morphology lab also depends on `morphology/template.txt` and the live stylesheet `anatomy-test.css`. The habitat lab depends on `habitat-lab.mjs`, `habitat.css`, the shared scenery modules and the shared specimen renderer.
