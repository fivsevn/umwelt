...
export function drawSpecies(collection,seed){const unseen=habitatSpecies.filter(s=>!collection.unlocked.includes(s.id));const pool=unseen.length?unseen:habitatSpecies;return pool[hash(seed,collection.draws+901)%pool.length].id}
