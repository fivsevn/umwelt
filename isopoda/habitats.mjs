...
const configs=[
 ...
 {id:'freshwater',days:3,names:['淡水腐殖池','Freshwater pool','淡水の腐葉池'],scene:'freshwater',aquatic:true,species:['aquaticus','meridianus','coxalis','communis','fontinalis'],defaults:{flow:30,oxygen:68,light:38,cover:65,detritus:55,salinity:0,tide:100,algae:55},palette:['#273b32','#344439','#4e5140','#68634b'],plants:14,rocks:4,wood:true,motion:['crawl','cling','crawl','crawl','cling'],metrics:['flow','oxygen','detritus'],tides:null},
 {id:'estuary',days:3,names:['河口汽水带','Estuarine brackish margin','河口汽水域'],scene:'estuary',aquatic:true,species:['hookeri','rugicauda','chelipes','carinata','nordmanni'],defaults:{flow:40,oxygen:72,light:48,cover:66,detritus:48,salinity:14,tide:38,algae:58},palette:['#263d3a','#3b5148','#67705a','#8e8b6d'],plants:12,rocks:7,wood:false,motion:['cling','crawl','swim','crawl','cling'],metrics:['salinity','tide','detritus'],tides:[38,74,91,31,67,85,24,59,80]},
 {id:'intertidal',days:3,names:['潮间带岩池','Intertidal rock pool','潮間帯の潮だまり'],scene:'intertidal',aquatic:true,species:['serratum','pelagica','granulosa','albifrons','bidentata'],defaults:{flow:58,oxygen:80,light:62,cover:62,detritus:30,salinity:34,tide:24,algae:35},palette:['#324743','#405552','#69736a','#9b9880'],plants:6,rocks:13,wood:false,motion:['cling','crawl','cling','crawl','cling'],metrics:['tide','salinity','flow'],tides:[24,72,94,41,86,58,18,64,90]},
