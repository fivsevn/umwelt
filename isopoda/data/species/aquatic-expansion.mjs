...
const TAXA=[
 ...
 {id:'ischiosetosa',taxon:'Jaera ischiosetosa',authority:'Forsman, 1949',habitats:['intertidal'],suborder:'Asellota',family:'Janiridae',max:5,color:'#817b69',shape:'jaera',speed:.72,micro:'Sheltered intertidal shores, especially reduced-salinity patches under stones with freshwater runoff.'},
 ...
 {id:'maculosa',taxon:'Janira maculosa',authority:'Leach, 1814',habitats:['shallow-marine'],suborder:'Asellota',family:'Janiridae',max:10,color:'#9a835d',shape:'janira',speed:.78,micro:'Lower intertidal to shallow sublittoral; under stones, among sponges and bryozoans, and in Laminaria holdfasts.'},
...
const NOTES={
 hilgendorfii:['河川、湖沼、池与沟渠只是地图上的分类；腐叶落到水里以后，分解者沿着更细的边界工作。','同属的身体轮廓很相似。没有显微鉴别特征时，像素只保留科级与体型差异。'],
 ischiosetosa:['淡水径流把盐度切成很短的梯度。石头底下的一小片水，对毫米级身体已经足够成为另一种环境。','它太小，很多鉴别点落在像素之外。无法显示的刚毛，不应被颜色代替。'],
 bidentata:['幼体在藻间，成体进入裂缝与藤壶空壳。生命周期把“同一种环境”拆成不同尺度。','雌雄尾部形态并不相同。这里的轮廓只能保存共同结构，不能冒充性别鉴定。'],
 ...
 hookeri:['河口没有稳定的盐度线。潮汐、径流与泥底把“海水”和“淡水”反复混在一起。','能卷曲的轮廓容易被看见，真正用于分种的刚毛排列却很难进入这张图。'],
 rugicauda:['盐沼池、海藻、漂木与泥壁都能成为同一物种的遮蔽。环境不是一种材质。','尾部的小瘤是资料中的鉴别线索；像素只能把粗糙感保留到近似层级。'],
 chelipes:['藻、泥滩、盐沼水池和河口石块被同一个汽水梯度连接。','颜色会变化；比颜色更可靠的仍是触角、侧板与尾节形态。'],
 carinata:['泥里没有清楚的通道，细长身体却能把沉积物变成可经过的空间。','盐度范围来自群体记录，不是给单一个体画出的边界。']
};
