...
const TAXA=[
 ...
 {id:'virei',taxon:'Stenasellus virei',authority:'Dollfus, 1897',habitats:['groundwater'],suborder:'Asellota',family:'Stenasellidae',color:'#b98f83',dark:'#684f4d',shape:'stenasellid',speed:.72,evidence:['release-virei-ijs','release-virei-persee'],micro:'Subterranean-water isopod recorded from caves, phreatic waters and river underflow; typical material is elongate and rose-coloured.',max:8}
];
