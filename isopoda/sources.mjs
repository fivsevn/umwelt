...
export const frameworkSources = [
 {id:'external-anatomy',level:'A1',type:'MORPHOLOGY',title:'陆生等足类外部形态',url:'https://pmc.ncbi.nlm.nih.gov/articles/PMC6288251/',supports:['anatomy.cephalon','anatomy.pereon','anatomy.pleon','anatomy.pleotelson','anatomy.uropods','anatomy.antennae']},
 {id:'armadillidium-venezillo-head-tail',level:'A1',type:'MORPHOLOGY',title:'Rapa Nui Oniscidea identification characters',url:'https://pmc.ncbi.nlm.nih.gov/articles/PMC4525033/',supports:['template.armadillidium.cephalon','template.armadillidium.pleotelson','template.armadillidium.uropods','template.venezillo.cephalon','template.venezillo.pleotelson','template.venezillo.uropods']},
 {id:'ardentiella-reassessment-2025',level:'A1',type:'MORPHOLOGY',title:'Reassessment of Merulanella and allied Armadillidae',url:'https://doi.org/10.3897/nhcm.2.144386',supports:['template.ardentiella.cephalon','template.ardentiella.antennae','template.ardentiella.pleotelson','template.ardentiella.uropods']},
