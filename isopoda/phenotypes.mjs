...
export function phenotypeFor(id){
 ...
 return {
  ...
  body:{length,width,convexity,projection:{middle:.60,frontWidth:.60,rearWidth:.48},anteriorTaper:roller?.16:.24,posteriorTaper:roller?.16:.32,pleonTaper:roller?.12:.4},
