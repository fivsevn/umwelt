...
(async()=>{
 ...
 await page.route('**/habitat.mjs*',async route=>{
  ...
  body=body.replace('return {reset,stage,react,heartBurst,zoom,','if(canvas.id==="habitat")window.__habitatTest={actors:()=>critters,camera};\nreturn {reset,stage,react,heartBurst,zoom,');
