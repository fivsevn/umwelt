...
60% parallel middle, short asymmetric rounded trapezoidal ends. Side plates occupy
compressed edge cells instead of protruding outside the shell. Convexity controls
...
Validation: `node --test tests/*.test.mjs` (25 tests), including all 13 species ×
